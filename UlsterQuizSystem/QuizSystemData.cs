    ...
    public class QuizSystemData
    {
        ...
        public void LoadSampleData()
        {
            ...
            var oopQuestions = new List<Question>
            {
                ...
                new Question("What is the difference between a class and an object?", new List<string>{"Class is an instance and object is a blueprint", "Class is a blueprint and object is an instance", "They are the same", "Object inherits class"}, "Class is a blueprint and object is an instance", "Medium"),
            ...
            Quizzes.AddRange(new[]
            {
                ...
                new Quiz("Software Design", "Includes design patterns, architecture principles, and system modelling.", Categories[2], new DateTime(2025, 09, 01)),
                new Quiz("Web Development", "HTML, CSS, JavaScript and client-server interactions", Categories[3], new DateTime(2025, 09, 07)),
                new Quiz("Database Systems", "SQL queries, relational models, normalization, and transactions.", Categories[4], new DateTime(2025, 09, 07)),
                new Quiz("Cybersecurity Basics", "Encryption, authentication, and common security threats.", Categories[5], new DateTime(2025, 09, 11)),
                new Quiz("Computer Networks", "Protocols, IP addressing, routing, and network layers.", Categories[6], new DateTime(2025, 09, 13))
            });
